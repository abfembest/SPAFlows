...
INCLUDE 'db_connect.php';
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="addstocksa.php" style ="color:white;">Add stocks</a></li>
              <li class="breadcrumb-item active" style ="color:white;"><a href="newstocksa.php" style ="color:white;">New stocks</a></li><?php 
        ...
        <div class="row">
          <div class="col-10">
                ...
                <h3 class="card-title">
                  ...
                  <form action="" method="POST">  
                      ...
                      <label class="form-inline" style="padding-left: 10px;">Current total sales
                        <?php
                              $name = $_SESSION['name'];
                            $query = "SELECT *, SUM(quantity*unit_price) AS currentsale, transaction_date FROM perfecttouch.products_sales WHERE transaction_date = current_date AND username='$name'";
                            $result = mysqli_query($connect, $query);    
                            while ($row = mysqli_fetch_array($result)){
                  ...
                  <?php
                    if (isset($_SESSION["status2"])) {
                        echo"<p class = 'btn-danger'>" .$_SESSION["status2"]."</p>"; 
            ...
            <div class="row">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="actions/action_productsalesa.php" method="POST">
                <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Email" id="Brand" name="unit_price" required="required" readonly value="<?php echo $row['price'];?>" >
                    </div>
                  </div>
                  <!--<div class="col-sm-4">
                      <div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="number" class="form-control" id="inputEmail3" placeholder="How many units?" id="Brand" name="quantity" min="0" required="required" step="any" >
                    </div>
                  </div> 
                </div>
                <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">Cust. Name:</label>
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Customer's name" id="Brand" name="fullname" class="wide" min="0" required="required" >
                    </div>
                  </div> 
                </div>
                <!--<div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="number" class="form-control" id="inputEmail3" placeholder="Price per unit" id="Brand" name="unit_price" class="wide" min="0" required="required" >
                    </div>
                  </div> 
                </div>
                <div class="form-group row">
  ...
  ?>
    ...
    <div class="col-md-10">
            ...
            <div class="card card-warning">
              <div class="card-header">
                <a href="actions/action_completepa.php" style="float: right; padding-left: 2px;"> <input type="   button" name="refresh" value="Complete sales" class="btn btn-danger"> 
                  </a> 
                  <a href="paymentp.php" style="float: right; padding-left: 2px;"> <input type="   button" name="refresh" value="payment" class="btn btn-info"> 
                  </a> 
 ...
 $sql = "SELECT id, invoice_id, type, quantity, unit_price,cost, custname FROM perfecttouch.products_sales WHERE username= '$name' AND status =0";
  $result = $connect->query($sql);
  if ($result-> num_rows >0) {
    while ($row = $result-> fetch_assoc()) {?>
      ...
      <tr>
          ...
          <td class="description"><?php echo $row['custname']; ?></td>
          ...
          ?>" class="btn btn-danger" id="delete">Delete</a></td>-->
            ...
            <?php
              ...
              ?>
         <td class="description"><a href ="printpos/directreceiptp.php" name = "print">print invoice</a></td>   
