        ...
        <div style="max-width: 1000px;margin-top: 3px;">
          <div class="card">
            <div class="card-header">
              ...
              <h2 class="card-title"><a href="reportpagea.php"><button class="btn btn-info">Back</button></a> <b> PERFECT TOUCH SALON AND SPA SERVICES Sales reports for today  <span id="span1"><script type="text/javascript">
                var dat = new Date();
    ...
    //$produce = $_POST['produce'];
     // formating the dates
      ...
      $name = $_SESSION['name'];
          ...
          $sql ="SELECT *
            FROM perfecttouch.sales WHERE transaction_date BETWEEN '$dat1' AND '$dat2'AND username ='$name'";
