        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="row">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="actions/action_expensesa.php" method="POST">
            ...
            <!-- small box -->
                  <div class="small-box bg-danger">
                    <?php 
                                  $query = "SELECT sum(amount) as expenses FROM olaoluwa.expenses where transaction_date =current_date";
