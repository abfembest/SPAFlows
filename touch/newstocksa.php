  ...
  <div class="content-wrapper" style="background: url('images/background.jpg'); background-size: cover;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="color: white;">Create new products to your list</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="row">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="actions/action_newproducka.php" enctype='multipart/form-data' method="POST">
                <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Description" id="Brand" name="category" class="wide" min="0" required="required"  >
                    </div>
                  </div> 
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      <div>
                      <input type="number" class="form-control" id="inputEmail3" placeholder="Price per unit" id="Brand" name="price" class="wide" min="0" required="required" >
                    </div>
                  </div> 
                  <div class="col-sm-4">
                      <div>
                      <input type="number" class="form-control" id="inputEmail3" placeholder="wholesale price" id="Brand" name="wholesaleprice" class="wide" min="0" required="required" >
                    </div>
                  </div> 
                </div>
                <!--<div class="form-group row">
