  ...
  <div class="content-wrapper" style="background: url('images/background.jpg'); background-size: cover;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="color: white;">Pay money here</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-10">
                ...
                <h3 class="card-title">
                  <form action="" method="POST">  
                      ...
                      <span class="form-inline"><label>Products:&nbsp&nbsp&nbsp</label>
                        <select  id="product" name="fullname" required="required" class="form-inline">
                        <option style=""></option>
                        <?php
                            $query = "SELECT DISTINCT fullname FROM olaoluwa.customerlist ";
            ...
            <div class="row">
              ...
              <?php
                  if(isset($_POST['Search'])){
                    $name = $_POST['fullname'];
                     ...
                     $query = "SELECT * FROM olaoluwa.customerlist  where fullname='$name'";
                    $result = mysqli_query($connect, $query);
                    while ($row = mysqli_fetch_array($result)) {
                    ?>
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="actions/action_pay.php" enctype='multipart/form-data' method="POST">
                <div class="card-body">
