        ...
        <div style="max-width: 1000px;margin-top: 3px;">
          <div class="card">
            <div class="card-header">
              ...
              <h2 class="card-title"><a href="newasseta.php"><button class="btn btn-info">Back</button></a> <b>PERFECT TOUCH SALON AND SPA ASSET LISTS  <span id="span1"><script type="text/javascript">
                var dat = new Date();
    ...
    //$produce = $_POST['produce'];
     // formating the dates
      ...
      //$date2 = $date->format('Y-m-d');
          ...
          $sql ="SELECT *FROM perfecttouch.assets";
