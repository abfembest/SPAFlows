  ...
  <div class="content-wrapper" style="background: url('images/background.jpg'); background-size: cover;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 style="color: white;">Register customers</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-9">
            ...
            <div class="row">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="actions/action_cust.php" enctype='multipart/form-data' method="POST">
                <div class="card-body">
                  <?php
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Full name" id="Brand" name="fullname" class="wide" min="0" required="required"  >
                    </div>
                  </div> 
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                        <input type="phone" class="form-control" id="inputEmail3" placeholder="Phone number" id="Brand" name="phone" class="wide" minlength="11" maxlength="11" required="required"  >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <div>
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Address?" id="Brand" name="address" class="wide"  required="required"  >
                    </div>
                  </div> 
                </div>
