...
<html>
<head>
  <title>Perfect Touch Salon and SPA Customers' reports</title>
        ...
        <div style="max-width: 1000px;margin-top: 3px;">
          <div class="card">
            <div class="card-header">
              ...
              <h2 class="card-title"><a href="reportpage.php"><button class="btn btn-info">Back</button></a> <b>Perfect Touch Salon and SPA Customers' reports for today  <span id="span1"><script type="text/javascript">
                var dat = new Date();
    ...
    //$produce = $_POST['produce'];
     // formating the dates
      ...
      //$date2 = $date->format('Y-m-d');
          ...
          $sql ="SELECT fullname, phone, count(fullname) AS visitation, transaction_date FROM perfecttouch.sales group by fullname ORDER BY visitation DESC";
...
<tr>
  ...
  $sql ="SELECT  count(fullname) as texpense,transaction_date
  ...
  echo "</table>";
   echo "<tr>
        <th>Total current patronages  </th><td><b>  ".($texpense)."</b></td></td>";
  echo "</tr><br>";    
