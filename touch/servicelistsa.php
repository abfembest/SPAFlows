        ...
        <div style="max-width: 1000px;margin-top: 3px;">
          <div class="card">
            <div class="card-header">
              ...
              <h2 class="card-title"><a href="servicesa.php"><button class="btn btn-info">Back</button></a> <b>PERFECT TOUCH SALON AND SPA SERVICES   <span id="span1"><script type="text/javascript">
                var dat = new Date();
...
<tr>
          ...
          <td ><a href="actions/action_updbt1.php?id=<?php echo $row['id'];
