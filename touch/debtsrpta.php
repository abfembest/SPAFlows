        ...
        <div style="max-width: 1000px;margin-top: 3px;">
          <div class="card">
            <div class="card-header">
              ...
              <h2 class="card-title"><a href="servicesa.php"><button class="btn btn-info">Back</button></a> <b>Perfect Touch Salon and SPA Customers' reports for today  <span id="span1"><script type="text/javascript">
                var dat = new Date();
