        ...
        <div style="max-width: 1000px; margin-top: 4px;">
          <div class="card">
            <div class="card-header">
              ...
              <h2 class="card-title"><a href="reportpagea.php"><button class="btn btn-info">Back</button></a> <b>Product reports for today  <span id="span1"><script type="text/javascript">
                var dat = new Date();
  ...
  if(isset($_POST['search'])){
   ...
   $date = date('Y-m-d');
          ...
          $sql ="SELECT category, type, quantity, price, transaction_date, (quantity*price) as value
            FROM perfecttouch.product2 ORDER BY quantity DESC";
