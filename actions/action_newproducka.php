...
if(isset($_POST['submit'])){
  ...
  //if( in_array($imageFileType,$extensions_arr) )
     ...
     $query = "INSERT into perfecttouch.product2 (category, type,quantity, price, username,wholesaleprice, transaction_date) 
              VALUES('$category','$type','$quantity','$price','$username', $wholesaleprice ,current_date)";
    ...
    //move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name);
      ...
      echo "Saved.<br>";
      echo '<a href="../newstocksa.php">Go!</a></p>';

  } else {
          echo "Error, stock cannot be taken or product type already exist.";
           echo'<a href="../newstocksa.php"."".>Go back!</a></p>';
