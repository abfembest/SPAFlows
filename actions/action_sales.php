...
//if(!empty($card_no)||(!empty($firstname)||(!empty($mothername)||!empty($pphone)||!empty($age)||!empty($dob)||(!empty($teacher)){
	...
	//creating connections.
    			...
    			$sql="INSERT INTO perfecttouch.sales (invoice_id, fullname,phone,type, staff, quantity, unit_price, username, paymethod, transaction_date) VALUES ( '$invoice_id','$fullname','$phone', '$type','$staff','$quantity','$unit_price','$username',$paymethod, current_timestamp)";
