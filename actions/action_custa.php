...
if(isset($_POST['submit'])){
  ...
  //if( in_array($imageFileType,$extensions_arr) )
     ...
     $query = "INSERT into perfecttouch.customerlist (fullname, address,phone, odebt,amount, transaction_date) 
