...
$odebt= filter_input(INPUT_POST, 'outstanding');
$apaid= filter_input(INPUT_POST, 'apaid');
...
if(isset($_POST['submit'])){
  ...
  //if( in_array($imageFileType,$extensions_arr) )
     ...
     $query = "INSERT into olaoluwa.payments (fullname, phone, address,outstanding,apaid, username,transaction_date) 
              VALUES('$fullname','$address','$phone','$odebt','$apaid', $username,current_date)";
    ...
    //move_uploaded_file($_FILES['file']['tmp_name'],$target_dir.$name);
      ...
      echo "Saved.<br>";
      echo '<a href="../pay2.php">Go!</a></p>';

  } else {

            $_SESSION["status"]="Error making payment.";
