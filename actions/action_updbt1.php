          ...
          <div class="col-10">
            ...
            <div class="row" >
               <div class="col-sm-12">
                ...
                <h3 class="card-title"><a href="../servicelistsa.php"><button class="btn btn-secondary">Back</button></a></h3>

              </div>
				<form class="form-horizontal" action="action_updatecustomera.php" enctype='multipart/form-data' method="POST">
                <div class="card-body">
